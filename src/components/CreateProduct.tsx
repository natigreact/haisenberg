...
export const CreateProduct: React.FC<ICreateProductProps> = ({ onCreate }) => {
    ...
    const onSubmit: SubmitHandler<ICreateProductInputs> = (throttle(async ({
                                                                               title,
                                                                               price,
                                                                               description,
                                                                               image,
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className='mt-5 flex flex-col'>
            ...
            <button type='submit'
                    className='py-2 px-4 border bg-yellow-400 hover:text-white mx-auto rounded-full mt-3'>Create
            </button>
        </form>
    )
}